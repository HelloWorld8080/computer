...
from camera import cap as camera
if __name__ == '__main__':
    try:
        camera.setExposureAuto(1)
        camera.setExposureTime(5000)
        camera.setGain(0.7)
...
decode("./result/Image_20220729200452524/Image_20220729200452524.png","./result/Image_20220729200452524","Image_20220729200452524")
